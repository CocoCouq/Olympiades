...
<main>
    ...
    <div class="row">
        ...
        <div class="col s12 black-back border-gold">
            <div>
                <p class="text-25 secondFont white-text">Un tour</p>
                <span class="red-text">Le tour commence par un cul sec du premier joueur de chaque équipe</span>
