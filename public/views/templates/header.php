        ...
        <nav class="gold-back">
            <div class="nav-wrapper row black-back">
                ...
                <ul class="right hide-on-med-and-down">
                    <!--Proofs-->
                    <li>
                        <a class='dropdown-trigger text-20 dropNav' href='#' data-target='dropdownProof' title="Toutes les epreuves">Epreuves</a>
                        ...
                        <ul id='dropdownProof' class='dropdown-content border-gold gold-back'>
                            ...
                            <div class="gold-back">
                                ...
                                <li><a class="black-text text-contrast" href="../proofs/corn.php" title="Cornhole">Cornhole</a></li>
...
<ul class="sidenav grey darken-4" id="mobile-demo">
    ...
    <li><a href="../talk/talk.php" class="red-text" title="Trash Talk">Trash talk<i class="material-icons red-text">whatshot</i></a></li>
