...
<ul class="sidenav grey darken-4" id="mobile-demo">
    ...
    <li><a href="../talk/talk.php" class="white-text secondFont" title="Trash Talk">Trash talk<i class="material-icons red-text">whatshot</i></a></li>
    <li><a href="../presentation/about.php" class="white-text secondFont" title="Trash Talk">Be Olympiades<i class="material-icons yellow-text">grade</i></a></li>
    ...
    <li>
        <a href="../login/login.php" class="white-text secondFont" title="Compte"><i class="material-icons white-text">person</i> Mon Compte</a>
    </li>
    <li class="divider"></li>
    <li>
